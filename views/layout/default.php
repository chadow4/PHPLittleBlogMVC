...
<header class="row align-items-center py-3">
    ...
    <ul class="mt-3 mt-lg-0 col-12 col-lg-4 d-flex align-items-center justify-content-center gap-5 nav__list">
        <?php if (isset($_SESSION['user_id'])): ?>
            <li class="nav__item"><a href="/mvc/authusers/logout" class="nav__link nav__link--button">Déconnexion</a></li>
        <?php else: ?>
            <li class="nav__item"><a href="/mvc/authusers/login" class="nav__link">Connexion</a></li>
            <li class="nav__item"><a href="/mvc/authusers/register" class="nav__link nav__link--button">Inscription</a></li>
        <?php endif; ?>
    </ul>
    </div>
